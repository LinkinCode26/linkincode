...
const es = {
  ...
  tech: {
    ...
    subtitle: 'El core tecnológico con el que construimos productos reales y escalables.',
  },
  ...
  solutions: {
    ...
    simulatorReady: {
      ...
      description: 'Probá este panel con datos de ejemplo, sin conexión a datos reales.',
    ...
    simulator: {
      ...
      disclaimer: 'Simulación visual — no se envía ni almacena en nuestros servidores.',
      dashboard: {
        ...
        disclaimer: 'Datos simulados con fines demostrativos — no representan información real ni se envían a ningún servidor.',
      },      
    },
  },
  ...
  process: {
    ...
    steps: [
      ...
      { title: 'Propuesta y Diseño', description: 'Definimos alcance, tiempos y presupuesto.' },
      { title: 'Desarrollo e Implementación', description: 'Creamos y lanzamos la solución.' },
      { title: 'Capacitación y Soporte', description: 'Te acompañamos en el uso.' },
    ],
  },
  ...
  team: {
    ...
    subtitle: 'Cuatro perfiles, un mismo compromiso: entregar software confiable.',
    members: [
      {
  ...
  contact: {
    ...
    subtitle: 'Contanos sobre tu proyecto. Te respondemos en menos de 24 horas con una propuesta clara.',
  ...
  ctaPrefooter: {
    ...
    subtitle: 'Agenda una llamada gratuita de 20 minutos con nuestro equipo, sin compromiso.',
  ...
  footer: {
    ...
    columns: {
      ...
      services: {
        title: 'Servicios',
        links: ['Landing Pages', 'E-commerce', 'APIs REST', 'Dashboards', 'Proyecto a medida'],
      },
      contact: {
        title: 'Contacto',
...
const en = {
  ...
  solutions: {
    ...
    services: {
      ...
      billing: {
        ...
        description: 'Billing modules with automatic invoice generation and revenue reports.',
        bullets: [
    ...
    simulator: {
      ...
      simulateDescription: 'A fast, modern landing page ready to turn visitors into customers.',
      ...
      disclaimer: 'Visual simulation — nothing is sent or stored on our servers.',
      dashboard: {
        ...
        disclaimer: 'Simulated data for demonstration purposes only — it does not represent real information and is not sent to any server.',
      },      
    },
  },
  ...
  process: {
    ...
    steps: [
      ...
      { title: 'Proposal & Design', description: 'We define scope, timeline and budget.' },
      { title: 'Development & Implementation', description: 'We build and launch the solution.' },
      { title: 'Training & Support', description: 'We support you along the way.' },
    ],
  },
  ...
  team: {
    ...
    subtitle: 'Four profiles, one shared commitment: delivering reliable software.',
    members: [
      {
        name: 'Santiago Molina',
  ...
  contact: {
    ...
    subtitle: "Tell us about your project. We'll get back to you in under 24 hours with a clear proposal.",
    emailLabel: 'Email us',
    whatsappLabel: 'WhatsApp',
    scopeLabel: 'Reach',
  ...
  footer: {
    ...
    columns: {
      ...
      services: {
        title: 'Services',
        links: ['Landing Pages', 'E-commerce', 'REST APIs', 'Dashboards', 'Custom project'],
      },
      contact: {
        title: 'Contact',
